...
const createRestaurantDetailTemplate = (restaurant) => `
  <article class="card card-restaurant-item">  
    <div class="list_item">
      ...
      <img class="thumb lazyload" data-src="${API_ENDPOINT.IMG_RESTAURANT}/${restaurant.pictureId}" alt="${restaurant.name}" title="${restaurant.name}">
  ...
  for (let i = 0; i < count; i += 1) {
    ...
    <article class="card card-restaurant-item">
        <div class="list_item">
          ...
          <img class="list_item_thumb lazyload" data-src="./placeholder.png" alt="skeleton" title="skeleton" crossorigin="anonymous">
          <div class="list_item_content">
            <div class="list_item_rating">
              <i class="fas fa-star"></i>
...
const createRestaurantItemTemplate = (restaurant) => `
  <article class="card card-restaurant-item">  
    <div class="list_item">
      <h3 class="list_item_city">${restaurant.city}</h3>
      <img class="list_item_thumb lazyload" data-src="${API_ENDPOINT.IMG_RESTAURANT}/${restaurant.pictureId}" alt="${restaurant.name}" title="${restaurant.name}">
      <div class="list_item_content">
        <div class="list_item_rating">
          <i class="fas fa-star"></i>
          <a href="#" class="list_item_rating_value">${restaurant.rating}</a>
